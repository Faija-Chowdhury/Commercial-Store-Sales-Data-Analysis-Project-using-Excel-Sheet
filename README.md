...
This project is a comprehensive Excel-based dashboard that analyses sales and order data from an Indian commercial online store. It provides valuable insights into customer behaviour and sales performance.

# Tools Used:

# Microsoft Excel

 Pivot Tables, Charts (Bar, Column, Pie), Data Cleaning, and Conditional formatting.

# Key Insights & Visualizations:

1. Orders vs Sales Trend: Monthly revenue tracking with a line-bar combination chart.

2. Sales by Gender: A pie chart showing the distribution between male and female customers.

3. Order Status: Breakdown of delivered, refunded, returned, and cancelled orders.
...
7. Interactive Slicers: Filter data by category, channel, and months.
 ...
 2. Practised data cleaning using Excel tools.

 3. Visualised key performance indicators for business reporting.
...
# Conclusion to improve commercial store sales:
